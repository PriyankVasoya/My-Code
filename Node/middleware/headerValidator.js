...
var bypassMethod = new Array("sendnotification", "signup", "login", "forgotPassword", "search","company", "product_list","product_list_by_category");
...
var headerValidator = {
    ...
    validateHeaderToken: function (req, res, callback) {
        ...
        if (bypassMethod.indexOf(path_data[2]) === -1) {
            console.log(bypassMethod.indexOf(path_data[2]))
